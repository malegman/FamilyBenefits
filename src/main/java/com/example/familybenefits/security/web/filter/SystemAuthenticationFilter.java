 ...
 */
@Component
public class SystemAuthenticationFilter extends BasicJwtAuthenticationFilter {
   ...
   */
  public SystemAuthenticationFilter(AccessTokenRepository accessTokenRepository) {
